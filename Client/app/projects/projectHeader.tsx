    ...
    <div className="px-4 xl:px-6">
      ...
      <div className="pb=6 pt-6 lg:pb-4 lg:pt-8">
        <Header
          ...
          buttonComponent={
            <button
              className="flex items-center rounded-md bg-blue-primary px-2 py-2 text-white hover:bg-blue-600"
      ...
      {/* TABS */}
      <div className="flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-8 pt-2 dark:border-stroke-dark md:items-center">
